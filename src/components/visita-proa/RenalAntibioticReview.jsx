    ...
    <div className="flex max-h-[94vh] w-full max-w-6xl flex-col overflow-hidden rounded-2xl border border-teal-200 bg-white shadow-2xl">
      ...
      <div className="min-h-0 flex-1 space-y-5 overflow-y-auto p-4 sm:p-6">
        ...
        <section className="space-y-3">
          <div><h3 className="font-black text-slate-950">Revisión sugerida</h3><p className="text-xs text-slate-500">Comparación entre la pauta de referencia con función renal conservada y la pauta correspondiente al CrCl/VFG calculado.</p></div>
