...
/**
 * Input de fecha en formato DD-MM-AAAA con autocompletado.
 * El usuario tipea solo dígitos y los guiones se insertan solos:
 *   "18"        → "18"
 *   "1805"      → "18-05"
 *   "18052026"  → "18-05-2026"
 * Emite onChange con valor ISO "YYYY-MM-DD" para que el resto de la app
 * (columnas DATE de Supabase) no cambie.
 *
...
export default function DateInputDdmm({ value, onChange, placeholder = 'DD-MM-AAAA', className = '', ...rest }) {
  ...
  const handleChange = (e) => {
    // Aceptar dígitos y guiones, descartar todo lo demás.
    const cleaned = e.target.value.replace(/[^0-9-]/g, '');
    // Quedarse solo con los dígitos para autoformatear consistentemente.
