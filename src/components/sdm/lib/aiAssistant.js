...
4) Un médico no puede estar en turno/posturno/ausencia y simultáneamente en un bloqueo, CON UNA EXCEPCIÓN: si el bloqueo es "subdireccion_medica" y el conflicto es con TURNO (urgencias) — no posturno ni ausencia — y el médico es **Fasani o Cordero** (NO Alvarado), entonces SE PUEDE dejar al titular en SDM (sigue figurando en turnos) y agregar un bloque adicional "urgencias_cobertura_sdm" 08:00–17:00 con otro médico libre. Esta salvedad NO aplica a Alvarado: si Alvarado está en turno, se considera no-disponible para SDM.
